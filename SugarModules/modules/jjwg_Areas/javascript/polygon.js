	  ...
	  * Some small changes made to original source.
    * 09/22/2010 
	  */
	 ...
	 function Pen(map){
		...
		this.draw = function(latLng){
			if (null != this.polygon) {
			  // JJW - Removed, It's not a good idea to have language in a javascript file that is minimized.
